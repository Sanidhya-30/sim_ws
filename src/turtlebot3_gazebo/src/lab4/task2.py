...
if __name__ == "__main__":
 ...
 # ros2 launch turtlebot4_navigation localization.launch.py map:=/home/lucifer/ros2_ws/src/task_7/maps/classroom_map.yaml namespace:=/robot
 # ros2 launch turtlebot4_viz view_robot.launch.py namespace:=/robot